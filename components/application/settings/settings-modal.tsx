    ...
    <div className="fixed inset-0 z-100 flex items-center justify-center p-4" role="presentation">
      ...
      >
        ...
        <nav
          ...
          className="flex w-[274px] shrink-0 flex-col gap-5 overflow-y-auto border-r border-border bg-muted p-2.5"
        >
          {NAV_GROUPS.map((group) => (
            <div key={group.label} className="flex w-full flex-col gap-1.5 pt-1">
              <span className="pl-2 text-body-medium text-muted-foreground">{group.label}</span>
                  ...
                  return (
                    <button
                      ...
                      className={cx(
                        ...
                        "outline-none transition-colors duration-150 ease focus-visible:ring-2 focus-visible:ring-ring",
                        selected
                          ? "bg-accent"
                          : "hover:bg-accent/60",
                      )}
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          ...
          >
            <h2 className="text-title-3-medium text-foreground">{PAGE_TITLES[page]}</h2>
            <button
              type="button"
              aria-label="Close settings"
              onClick={onClose}
          ...
          <div className="relative min-h-0 flex-1">
            ...
            <div
              aria-hidden
              className={cx(
                "pointer-events-none absolute inset-x-0 top-0 h-10 bg-linear-to-b from-card to-transparent",
      ...
      <div
        ...
        className={cx(
          ...
          "rounded-full border border-border bg-card py-1 pr-2.5 pl-1.5 shadow-[var(--overlay-surface-shadow)]",
      ...
      >
        <RiCheckboxCircleFill className="size-4 shrink-0 text-success" aria-hidden />
        <span className="text-body-2-medium whitespace-nowrap text-foreground">Saved</span>
      </div>
      </div>
    </div>,
    document.body,
