...
function SortableHeader({
  ...
  return (
    <button
      ...
      className="flex cursor-pointer items-center gap-0.5 rounded-sm outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-ring"
    >
      <span className={cx("text-body-medium whitespace-nowrap", active ? "text-foreground" : "text-muted-foreground")}>
        {label}
      </span>
...
export function SettingsStorage() {
  ...
  return (
    ...
    <div className="flex w-full flex-col gap-6 pt-2.5">
      ...
      <section className="flex w-full flex-col rounded-2xl border border-border pt-2 pb-3">
        {/* Toolbar */}
        <div className="flex w-full flex-col items-start gap-3 px-3 py-1 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex flex-col justify-center">
            <p className="text-body-medium whitespace-nowrap text-muted-foreground">Stored in</p>
            <p className="text-body-medium whitespace-nowrap text-foreground">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <InputBase
              ...
              fieldClassName="w-[153px] rounded-full bg-muted"
        ...
        {/* Column headers */}
        <div className="mt-2 flex w-full items-center border-y border-border bg-muted pl-3">
          ...
          <div className="flex w-[116px] shrink-0 items-center px-3 py-2.5">
              <span className="text-body-medium whitespace-nowrap text-muted-foreground">Actions</span>
          </div>
        </div>
        ...
        <div className="flex w-full flex-col pl-3">
          {rows.length > 0 ? (
                  ...
                  <div className="flex w-full items-center border-b border-border">
                    <div className="flex min-w-0 flex-1 items-center gap-2 py-2.5">
                      ...
                      <div className="flex min-w-0 items-center gap-2">
                        ...
                        <span className="truncate text-body-medium text-foreground">
                          {file.name}
                        </span>
                      </div>
                    </div>
                    <div className="flex w-[150px] shrink-0 items-center px-3 py-2.5">
                      <span className="text-body-medium whitespace-nowrap text-foreground">
                        {file.uploadedOn}
                      </span>
                    </div>
                    <div className="flex w-[104px] shrink-0 items-center px-3 py-2.5">
            ...
            <div className="flex w-full items-center justify-center py-10 pr-3">
              <span className="text-body-medium text-muted-foreground">No files match your filters.</span>
            </div>
          )}
        </div>
