          ...
          <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-6 text-center sm:gap-7">
            ...
            <div className="flex flex-col items-center gap-4 sm:gap-5">
              ...
              <p className="max-w-xl text-base leading-relaxed text-muted-foreground text-balance sm:text-lg sm:leading-8">
                Capture every request, send professional quotes, follow up on
                time, and track each deal from first contact to paid invoice.
              </p>
            </div>
          ...
          <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6 py-14 sm:py-16 lg:flex-row lg:gap-20">
            ...
            <div className="flex flex-col gap-5">
              ...
              <div className="flex items-center gap-4">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
                ...
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
                ...
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
                ...
                <a href="https://x.com" target="_blank" rel="noopener noreferrer" aria-label="X" className="text-primary-foreground/80 transition-colors hover:text-primary-foreground">
