  ...
  return (
    <DialogPortal forceMount>
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "overlay-surface modal-layer-content fixed bottom-2 left-1/2 top-auto flex max-h-[calc(100dvh-1rem)] w-[calc(100vw-1rem)] max-w-3xl -translate-x-1/2 translate-y-0 flex-col overflow-y-auto rounded-xl border text-popover-foreground duration-200 fill-mode-forwards data-open:animate-in data-open:fade-in-0 data-open:zoom-in-[0.97] data-closed:animate-out data-closed:fade-out-0 data-closed:zoom-out-[0.97] sm:bottom-auto sm:top-1/2 sm:max-h-[calc(100dvh-2rem)] sm:w-[calc(100vw-2rem)] sm:-translate-y-1/2 sm:overflow-hidden",
