  ...
  return (
    <>
      {!isExternal && (
        ...
        >
          <RiCalendarLine className="size-5 shrink-0 text-foreground" aria-hidden />
          <span className="flex items-center justify-center whitespace-nowrap px-1 text-body-medium text-foreground">
