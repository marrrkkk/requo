  ...
  return (
    <div
      ...
      className={cx(
        ...
        busy ? "bg-card" : "cursor-pointer bg-muted",
    ...
    >
      ...
      <div
        aria-hidden
        className={cx(
          "absolute -top-[9.5px] left-1/2 -translate-x-1/2 rounded-md bg-primary px-1.5 py-0.5",
          "text-caption-1-medium whitespace-nowrap text-primary-foreground tabular-nums",
      ...
      >
        <span className="t-stagger-line t-stagger-line--1 flex size-10 items-center justify-center rounded-full bg-primary/10 p-2.5">
          <RiUploadCloud2Line
            className="size-6 shrink-0 text-primary transition-colors duration-150 ease"
            aria-hidden
          />
        </span>
        <div className="flex flex-col items-center gap-2 text-center">
          <p
            className={cx(
              ...
              rejection ? "text-destructive" : "text-muted-foreground",
            )}
          >
            {rejection ?? (
              <>
                Drag and drop to upload or <span className="text-primary">select</span>
              </>
            )}
          </p>
          <p className="t-stagger-line t-stagger-line--3 text-body-2-regular text-muted-foreground">
      ...
      >
        <span className="t-stagger-line t-stagger-line--1 flex size-10 items-center justify-center rounded-full border border-border bg-card p-2">
          {file && (renderFileIcon ? renderFileIcon(file) : <DefaultFileIcon file={file} />)}
        </span>
        <p className="t-stagger-line t-stagger-line--2 mt-3.5 max-w-[90%] truncate text-body-medium text-foreground">
          {file?.name}
        </p>
        <div className="t-stagger-line t-stagger-line--3 relative mt-1 h-[18px] w-full">
          <p
            className={cx(
              "absolute inset-x-0 text-center text-body-2-regular text-muted-foreground",
