...
export function Kbd({ className, ref, ...props }: KbdProps) {
  return (
    <kbd
      ref={ref}
      className={cx(
        "inline-flex items-center justify-center rounded-full bg-muted px-1 py-0.5 font-sans text-caption-1-semibold tracking-normal whitespace-nowrap text-muted-foreground",
        className,
      )}
      {...props}
    />
