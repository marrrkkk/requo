...
ALTER TYPE "public"."business_notification_type" ADD VALUE 'quote_revision_requested' BEFORE 'business_member_invite_accepted';--> statement-breakpoint
ALTER TYPE "public"."quote_status" ADD VALUE 'revision_requested' BEFORE 'accepted';--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "quotes" DROP CONSTRAINT "quotes_totals_valid";--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "terms" text;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "tax_amount_in_cents" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "tax_label" text;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "version" integer DEFAULT 1 NOT NULL;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "auto_follow_up_enabled" boolean DEFAULT false NOT NULL;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "auto_follow_up_delay_days" integer DEFAULT 3 NOT NULL;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "auto_follow_up_max_attempts" integer DEFAULT 2 NOT NULL;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "auto_follow_up_attempts" integer DEFAULT 0 NOT NULL;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "auto_follow_up_last_sent_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "quotes" ADD COLUMN "auto_follow_up_stopped_at" timestamp with time zone;--> statement-breakpoint
ALTER TABLE "businesses" ADD COLUMN "default_quote_terms" text;--> statement-breakpoint
