 ...
 *
 * Mirrors the ProfileSettingsForm layout: a Card with CardHeader (title +
 * description), then a two-column grid with the avatar panel on the left
 * and two form sections on the right. No separate page header or footer
 * button — the real form uses floating unsaved-changes actions.
 */
