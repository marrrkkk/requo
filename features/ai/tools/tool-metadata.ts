...
export const dashboardToolMetadata: ToolMetadata[] = [
  {
    ...
    category: "data_query",
    intentTriggers: ["data_query", "analytics"],
  },
  {
    name: "count_quotes",
    category: "data_query",
  ...
  },
  {
    name: "search_quotes",
    category: "data_query",
    intentTriggers: ["data_query", "quote_action"],
  },
  {
  ...
  },
  {
    ...
    category: "analytics",
    intentTriggers: ["analytics"],
  },
  {
    name: "get_follow_ups",
    category: "follow_up_management",
    intentTriggers: ["follow_up_action"],
  },
  {
    name: "list_inquiries",
    category: "data_query",
    intentTriggers: ["data_query"],
  },
  {
    name: "list_quotes",
    category: "data_query",
  ...
  },
  {
    ...
    category: "data_query",
    intentTriggers: ["data_query", "follow_up_action"],
  },
  {
    name: "get_expiring_quotes",
    category: "quote_management",
    intentTriggers: ["quote_action", "follow_up_action"],
  },
  {
    name: "get_customer_history",
    category: "customer_lookup",
    intentTriggers: ["data_query", "quote_action", "follow_up_action", "memory_recall"],
  },
  {
  ...
  },
  {
    ...
    category: "knowledge",
    intentTriggers: ["quote_action", "memory_recall"],
  },
  {
  ...
  },
  {
    ...
    category: "knowledge",
    intentTriggers: ["memory_recall", "workflow_guidance"],
  },
  {
